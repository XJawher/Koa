...
const fetchDataPer15s = () => {
    ...
    // // Cluster
    // //  Cluster: '/bd-cluster',
    // //  NodeGroup: '/bd-node-group',
    // //  ClusterInfo: '/bd-cluster:info',
    if (routerHash.match(main + routerPath.Cluster) || routerHash.match(main + routerPath.ClusterInfo)) {
        httpRequests.dashborad();
    }
